...
insert into Question (questionText, explanation, id_answer_correct, id_curso) values('Pergunta 1', 'Explanation1', 1, 2);
insert into Question (questionText, explanation, id_answer_correct, id_curso) values('Pergunta 2', 'Explanation2', 8, 2);
insert into Question (questionText, explanation, id_answer_correct, id_curso) values('Pergunta 3', 'Explanation3', 14, 2);
